...
func NewPublishPostFlow(topicId int64, content string) *PushPostFlow {
	return &PushPostFlow{
			content: content,
			topicId: topicId,
	}
...
type PushPostFlow struct {
	content	string
	topicId	int64
	postId	int64
}

func (f *PushPostFlow) Do() (int64, error) {
...
func (f *PushPostFlow) checkParam() error {
...
func (f *PushPostFlow) publish() error {
